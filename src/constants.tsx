...
export const PIECES: Record<string, React.ReactNode> = {
  ...
  wN: (
    <svg viewBox="0 0 45 45" className="w-full h-full">
      ...
      <path d="M24 18c.3 1.2 2.5 1.2 2.5.5s-1.5-2-2.5-.5z" fill="#000" />
      <path d="M9.5 25.5A.5.5 0 1 1 9 25a.5.5 0 0 1 .5.5z" fill="#fff" stroke="#000" />
      <path d="M15 15.5c4.5-4.5 11.7-2.5 11.7-2.5s-4.5 4.5-1.5 11.5c-4.5 1.5-10.2-9-10.2-9z" fill="#fff" stroke="#000" strokeWidth="1.5" />
    </svg>
  ),
  wB: (
    <svg viewBox="0 0 45 45" className="w-full h-full">
      <g fill="none" fillRule="evenodd" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        <g fill="#fff" strokeLinecap="butt">
          <path d="M9 36c3.39-.97 10.11.43 13.5-2 3.39 2.43 10.11 1.03 13.5 2 0 0 0 5-2 5H11c-2 0-2-5-2-5z" />
  ...
  wK: (
    <svg viewBox="0 0 45 45" className="w-full h-full">
      <g fill="none" fillRule="evenodd" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M22.5 25s4.5-7.5 3-10c-1.5-2.5-6-2.5-6 0-1.5 2.5 3 10 3 10" fill="#fff" strokeLinecap="butt" />
        <path d="M11.5 37c5.5 3.5 15.5 3.5 21 0v-7s9-4.5 6-10.5c-4-1-1-4-1-4--3 0-2.5 2-2.5 2-3.5-2-6-2-6-2 .5-2.5-.5-3.5-.5-3.5-1.5-1.5-2.5-1.5-2.5-1.5s-1 0-2.5 1.5c0 0-1 1-.5 3.5c0 0-2.5 0-6 2 0 0-.5-2-2.5-2 0 0 3 3-1 4 0 0 3 9.5-6 10.5-3 6 6 10.5 6 10.5v7z" fill="#fff" />
  ...
  bN: (
    <svg viewBox="0 0 45 45" className="w-full h-full">
      <path d="M22 10c10.5 1 16.5 8 16 29H15c0-9 10-6.5 8-21" stroke="#fff" strokeWidth="1.5" />
      <path d="M24 18c.3 1.2 2.5 1.2 2.5.5s-1.5-2-2.5-.5z" fill="#fff" />
      <path d="M9.5 25.5A.5.5 0 1 1 9 25a.5.5 0 0 1 .5.5z" fill="#fff" stroke="#fff" />
      <path d="M15 15.5c4.5-4.5 11.7-2.5 11.7-2.5s-4.5 4.5-1.5 11.5c-4.5 1.5-10.2-9-10.2-9z" stroke="#fff" strokeWidth="1.5" />
    </svg>
  ),
  bB: (
    <svg viewBox="0 0 45 45" className="w-full h-full">
  ...
  bR: (
    <svg viewBox="0 0 45 45" className="w-full h-full">
      <g fillRule="evenodd" stroke="#fff" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        <path d="M9 39h27v-3H9v3zM12 36v-4h21v4H12zM11 14V9h4v2h5V9h5v2h5V9h4v5" strokeLinecap="butt" />
        <path d="M34 14l-3 3H14l-3-3" />
        <path d="M31 17v12.5H14V17" strokeLinecap="butt" strokeLinejoin="miter" />
        <path d="M31 29.5l1.5 2.5h-20l1.5-2.5" />
  ...
  bK: (
    <svg viewBox="0 0 45 45" className="w-full h-full">
      <g fill="none" fillRule="evenodd" stroke="#fff" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M11.5 37c5.5 3.5 15.5 3.5 21 0v-7s9-4.5 6-10.5c-4-1-1-4-1-4--3 0-2.5 2-2.5 2-3.5-2-6-2-6-2 .5-2.5-.5-3.5-.5-3.5-1.5-1.5-2.5-1.5-2.5-1.5s-1 0-2.5 1.5c0 0-1 1-.5 3.5c0 0-2.5 0-6 2 0 0-.5-2-2.5-2 0 0 3 3-1 4 0 0 3 9.5-6 10.5-3 6 6 10.5 6 10.5v7z" />
        <path d="M11.5 30c5.5-3 15.5-3 21 0m-21 3.5c5.5-3 15.5-3 21 0m-21 3.5c5.5-3 15.5-3 21 0" />
      </g>
    </svg>
  ),
